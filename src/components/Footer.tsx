...
export default function Footer() {
  ...
  const content = isDutch
    ? {
        description:
          'EPB-certificaat in Brussel voor appartementen en woningen. Snelle interventie, duidelijke prijzen en eenvoudige begeleiding van het eerste contact tot het certificaat.',
        navigation: 'Navigatie',
        home: 'Home',
        apartment: 'EPB Appartement',
        house: 'EPB Woning',
        audit: 'Energie-audit',
        pricing: 'Tarieven',
        faq: 'FAQ',
        ...
        compliance: 'EPB-certificering conform de regelgeving van het Brussels Hoofdstedelijk Gewest',
      }
    : {
        description:

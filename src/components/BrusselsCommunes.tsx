      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-12 text-center">
          ...
          <h2 className="mb-4 text-3xl font-bold text-gray-900">
            {isDutch
              ? 'EPB-certificaat in alle Brusselse gemeenten'
              : 'Certificat PEB dans toutes les communes de Bruxelles'}
          </h2>
          <p className="mx-auto max-w-3xl text-lg text-gray-600">
            {isDutch
              ? 'Wij komen tussen in de 19 gemeenten van het Brussels Hoofdstedelijk Gewest voor EPB-certificaten van appartementen en woningen, evenals energie-audits.'
        ...
        <div className="mt-12 rounded-lg bg-emerald-50 p-8">
          <h3 className="mb-4 text-2xl font-bold text-gray-900">
            {isDutch
              ? 'Snelle en professionele EPB-certificering'
          ...
          <div className="grid gap-6 text-gray-700 md:grid-cols-2">
            <div>
              ...
              <p>
                {isDutch
                  ? 'Verplicht EPB-certificaat voor verkoop of verhuur van uw appartement in Brussel. Tarieven vanaf 120 € inclusief btw.'

...
export default function FAQ() {
  ...
  const faqData: FAQItem[] = isDutch
    ? [
        {
          question: 'Wat is een EPB-certificaat?',
          answer:
            'Het EPB-certificaat is een verplicht document dat de energieprestatie van een woning beoordeelt. Het is nodig bij verkoop of verhuur van residentieel vastgoed in Brussel.',
        },
        {
          question: 'Hoe lang duurt een EPB-bezoek?',
          answer:
            'Een volledig EPB-bezoek duurt doorgaans tussen 1,5 en 2,5 uur, afhankelijk van de grootte en de complexiteit van het pand.',
        },
        {
          question: 'Hoe lang blijft een EPB-certificaat geldig?',
          answer:
            'Een EPB-certificaat blijft 10 jaar geldig vanaf de opmaakdatum, behalve wanneer er intussen belangrijke energetische renovaties werden uitgevoerd.',
        },
        {
        ...
        {
          question: 'Is het EPB-certificaat verplicht?',
          answer:
            'Ja, het EPB-certificaat is in Brussel verplicht voor elke verkoop of verhuur van een woning en moet vermeld worden in vastgoedadvertenties.',
        },
      ]
    : [
        {
        ...
        <div className="mx-auto max-w-3xl">
          <div className="mb-16 text-center">
            <h1 className="mb-4 text-4xl font-bold text-gray-900">
              {isDutch ? 'FAQ – EPB-certificaat in Brussel' : 'FAQ – Certificat PEB à Bruxelles'}
            </h1>
            <p className="text-xl text-gray-600">
              {isDutch
                ? 'Alles wat u moet weten over het EPB-certificaat'

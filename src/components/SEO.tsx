...
export default function SEO({
  ...
  useEffect(() => {
    ...
    const structuredData = {
      ...
      name: 'K Certipeb',
      description: isDutch
        ? 'Expert in EPC-certificering en energie-audit in Brussel'
      ...
      mainEntity: isDutch
        ? [
            ...
            },
            {
              ...
              acceptedAnswer: {
                '@type': 'Answer',
                text: 'Wij komen langs binnen 48 uur en bezorgen het officiële EPC-certificaat binnen 3 tot 5 werkdagen na het bezoek.',
              },
            },
            {
              '@type': 'Question',

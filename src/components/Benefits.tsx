    ...
    ? [
        {
          ...
          description: 'EPB-certificateurs erkend door Leefmilieu Brussel met aantoonbare ervaring.',
        },
        {
        ...
        },
        {
          ...
          description: 'Een goed EPB-resultaat verhoogt de aantrekkelijkheid van uw eigendom.',
        },
      ]
    : [
        {

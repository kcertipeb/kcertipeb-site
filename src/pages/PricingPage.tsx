...
export default function PricingPage() {
  ...
  const content = isDutch
    ? {
        title: 'Tarieven EPB-certificaat in Brussel',
        description: 'Duidelijke tarieven voor uw EPB-certificaat in Brussel, zonder verborgen kosten.',
        popular: 'Populair',
        order: 'Bestellen',
        included: 'Wat is inbegrepen',
        includedItems: [
          'Volledig plaatsbezoek',
          'Officieel EPB-certificaat',
        ...
        seoTitle: 'Tarieven EPB-certificaat in Brussel',
        seoDescription:
          'Tarieven van het EPB-certificaat in Brussel vanaf 120 € voor een appartement en 210 € voor een woning.',
      }
    : {
  ...
  return (
    <>
      <SEO
        ...
        keywords={isDutch ? 'tarieven EPB Brussel, prijs EPB certificaat' : 'tarifs certificat PEB bruxelles, prix certificat PEB'}

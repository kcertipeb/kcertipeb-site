...
export default function ApartmentPEB() {
  ...
  const content = isDutch
    ? {
        seoTitle: 'EPB-certificaat appartement in Brussel',
        seoDescription: 'EPB-certificaat voor appartement in Brussel vanaf 120 €.',
        badge: 'EPB-certificaat appartement',
        title: 'EPB-certificaat voor appartement in Brussel',
        ...
        whyText: 'Wij zijn gespecialiseerd in EPB-certificering van appartementen in Brussel.',
        cards: [
        ...
        mandatoryText: 'Bij verkoop of verhuur van een appartement in Brussel is het EPB-certificaat verplicht.',
        ...
        order: 'Bestellen',
        finalTitle: 'Klaar om uw EPB-certificaat te ontvangen?',
